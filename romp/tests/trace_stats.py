...
class ModelResult:
    ...
    def __str__(self) -> str:
        return (f"{'='*80}\n"
                ...
                f"    abs-hit: {self.abs_state_hit_rate.min:16.2g} {self.abs_state_hit_rate.avg:16.4g} {self.abs_state_hit_rate.max:16.2g}\n"
                f"   abs-miss: {self.abs_state_miss_rate.min:16.2g} {self.abs_state_miss_rate.avg:16.4g} {self.abs_state_miss_rate.max:16.2g}\n"
